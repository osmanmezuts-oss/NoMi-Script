    ...
    menu.innerHTML = `
        ...
        <div style="margin:10px 0;">
            ...
            <div style="margin-bottom:16px;padding:12px;background:#0d0d1a;border-radius:12px;border:1px solid #333;">
                ...
                <div style="margin-bottom:8px;"><label style="font-size:12px;color:#888;display:block;margin-bottom:2px;">Modelo</label><input type="text" id="nomi-input-modelo" value="${modeloActual}" style="width:100%;padding:6px;border-radius:6px;border:1px solid #555;background:#0d0d1a;color:#fff;font-size:12px;"></div>
